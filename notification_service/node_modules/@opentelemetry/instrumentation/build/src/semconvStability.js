...
exports.semconvStabilityFromStr = void 0;
/**
...
function semconvStabilityFromStr(namespace, str) {
    let semconvStability = 2 /* SemconvStability.OLD */;
    ...
    for (const entry of entries ?? []) {
        if (entry.toLowerCase() === namespace + '/dup') {
            ...
            semconvStability = 3 /* SemconvStability.DUPLICATE */;
            break;
        }
        else if (entry.toLowerCase() === namespace) {
            semconvStability = 1 /* SemconvStability.STABLE */;
        }
    }
